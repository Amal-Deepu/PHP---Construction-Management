          ...
          <div class="body-inner">
            <div class="card bg-white">
              <div class="card-content">
                ...
                <form class="form-horizontal ng-pristine ng-valid" action="contractor_signup1.php" method="post">
                  <fieldset>
...
+91 2322150 , +91 9539700672</a>
					...
					<div class="col-lg-2 col-md-3 col-xs-12 mb-sm-30">
						...
						<ul class="link blog-link">
							<li>
								<a href="#about_us"><i class="fa fa-angle-double-right"></i> About Us</a>
							</li>
							<li>
								<a href="#service_section"><i class="fa fa-angle-double-right"></i> Services</a>
							</li>
							<li>
								<a href="#project"><i class="fa fa-angle-double-right"></i> Privacy policy</a>
							</li>
							<li>
