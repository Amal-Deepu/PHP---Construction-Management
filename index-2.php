					...
					<div class="row">
						...
						<div class="col-md-9 nav-bg d-flex align-items-center">
							<nav class="navigation">
								<ul>
									<li>
										<a href="javascript:avoid(0);">Home</a><i class="ion-ios-plus-empty hidden-md-up"></i>
										<ul class="sub-nav">
											<li>
									...
									<li>
										<a href="javascript:avoid(0);">About us</a><i class="ion-ios-plus-empty hidden-md-up"></i>
										<ul class="sub-nav">
									...
									<li>
										<a href="javascript:avoid(0);">bolg</a><i class="ion-ios-plus-empty hidden-md-up"></i>
										<ul class="sub-nav">
											<li>
									...
									<li>
										<a href="javascript:avoid(0);">Contact Us</a><i class="ion-ios-plus-empty hidden-md-up"></i>
										<ul class="sub-nav">
						...
						<li data-index="rs-131">
							...
							data-responsive_offset="on" >
								<div class="banner-text">
									...
									<p>
									Over the course of 42 years, what started out as a humble beginning has turned out into a fully-fledged working entity. Palathra Constructions Pvt. Ltd. is a firm with the desire and determination to serve the society through quality construction works.
									</p>
									<a class="btn-text" href="about_us.html"> read more</a>
								</div>
							</div>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-4 mb-sm-30 mb-xs-30">
						<div class="post">
							<div class="post-img img-fluid">
								<a href="#!"> <img src="assets/images/blog/home_blog_1.jpg" alt="image"> </a>
							</div>
							<div class="post-content">
								<a href="#!" class="blog_tital"> Blog Title Goes Here</a>
								<p>
									Lorem ipsum dolor sit amet, consec tetur elit. In maximus ligula semper.
								</p>
								...
								<div class="info">
									<ul>
										<li>
											<a href="#"> <span class="ion-person"></span> Admin </a>
										</li>
										<li>
											<a href="#!"> <span class="icon-clock"></span> 6 August </a>
										</li>
										<li>
											<a href="#!"> <span class="flaticon-doctor-stethoscope"></span> Health Care </a>
										</li>
									</ul>
								</div>
							</div>
					...
					<div class="col-lg-4 mb-sm-30 mb-xs-30">
						<div class="post">
							<div class="post-img img-fluid">
								<a href="#!"> <img src="assets/images/blog/home_blog_2.jpg" alt="image"> </a>
							</div>
							<div class="post-content">
								<a href="#!" class="blog_tital"> Blog Title Goes Here</a>
								<p>
					...
					<div class="col-lg-4">
						<div class="post">
							<div class="post-img img-fluid">
								<a href="#!"> <img src="assets/images/blog/home_blog_3.jpg" alt="image"> </a>
							</div>
							<div class="post-content">
								<a href="#!" class="blog_tital"> Blog Title Goes Here</a>
								<p>
