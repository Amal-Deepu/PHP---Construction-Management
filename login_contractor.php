...
if(isset($_SESSION["name"])){
 header("Location: index-contractor.php");
}else{
?>
<!DOCTYPE html>
...
<head>
 ...
 <section class="inner-intro bg-img light-color overlay-before parallax-background">
    <div class="container">
      <div class="row title">
      	<div class="title_row">
      		<h1 data-title="Login"><span>Contractor Login</span></h1>
        ...
        <div class="col-sm-12">
        	<div class="main-body">
        	  <div class="body-inner">
        	    <div class="card bg-white">
        	      <div class="card-content">
					...
					<center>
					        ...
					        <form class="form-horizontal ng-pristine ng-valid" action="login_contractor_code.php" method="POST">
        	          <fieldset>
        	    ...
        	    <div class="additional-info"> <a href="contractor_forgotpassword.php">Forgotpassword?</a></div>
				 <div class="additional-info"> <a href="contractor_signup.php">Contractor's Click here to Register</a></div>
...
Palathra Constructions Pvt. Ltd. , Palathra buildings, Thuruthy P.O, Changanacherry, Kottayam.
						...
						<ul class="link-small">
							<li>
								<a href="mailto:business@support.com"><i class="ion-ios-email fa-icons"></i>T:
+91 2322150 , +91 9539700672</a>
							</li>
							<li>
								<a><i class="ion-ios-telephone fa-icons"></i>E:
