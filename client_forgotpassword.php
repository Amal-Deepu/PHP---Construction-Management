...
$name=$_POST['fullname'];
$email=$_POST['email'];
$query=mysqli_query($db,"select password from tbl_client where email='$email'");
...
$body ="Your password for Mastercraft Architecture login is :".$password;
$headers = "From:architecturemastercraft@gmail.com";
if (mail($to_email, $subject, $body, $headers)) {
   echo "<script>alert('Password successfully sent to $email');</script>";
  
} else {
    echo "<script>alert('Password sending failed');</script>";
}
} else {
echo "<script>alert('Invalid details. Please try with valid details');</script>";
echo "<script>window.location.href ='client_forgotpassword.php'</script>";
      ...
      <div class="row title">
      	<div class="title_row">
      		...
      		<div class="page-breadcrumb">
							<a>Home</a>/ <span>Forgotpassword</span>
						</div>
        	    ...
        	    <div class="card bg-white">
        	      <div class="card-content">
        	        <section class="logo text-center">
        	          <h2>Client Forgotpassword</h2>
        	        </section>
					<center>
								Please enter your name and email to recover password.<br />
        	          ...
        	          <fieldset>
        	            <div class="form-group">
        	              <div class="ui-input-group">
        	                <input type="text" required class="form-control" id="user" name="fullname" required="required" autofocus="autofocus">
        	            ...
        	            <div class="form-group">
        	              <div class="ui-input-group">
        	                <input type="email" required class="form-control" id="pass" name="email" required="required">
        	                <span class="input-bar"></span>
        	                <label>Email</label>
        	              </div>
        	            </div>
        	          </fieldset>
					 <center><button type="submit" name="submit"  value="Login" class="color-primary">submit<button></center>
        	        </form>
        	      </div>
        	    <!--  <div class="card-action no-border text-right"> <a href="#/" class="color-primary">Sign in</a> </div>-->
        	    </div>
        	    <div class="additional-info"> <a href="login_client.php"> Click here to Login</a></div>
