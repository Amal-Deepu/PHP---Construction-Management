...
$name=$_POST['fullname'];
$email=$_POST['email'];
$query=mysqli_query($con,"select password from  tbl_contractor where fullName='$name' and email='$email'");
        ...
        <div class="col-sm-12">
        	<div class="main-body">
        	  <div class="body-inner">
        	    <div class="card bg-white">
        	      <div class="card-content">
        	        <section class="logo text-center">
        	          <h2>Contractor Forgotpassword</h2>
        	        </section>
					<center>
        	    ...
        	    <div class="additional-info"> <a href="login_contractor.php"> Click here to Login</a></div>
