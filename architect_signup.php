            ...
            <div class="card bg-white">
              <div class="card-content">
                ...
                <section class="logo text-center">
                  <h2>Architect Registration</h2>
                </section>
                <form class="form-horizontal ng-pristine ng-valid" action="architect_signup1.php" method="post">
                  <fieldset>
                    <div class="form-group">
                      <div class="ui-input-group">
                        <input type="text" required class="form-control" name="username" pattern="[A-Za-z. ]{4,25}" title="only use uppercase or lowercase letters 4-25 characters allowed">
                    ...
                    <div class="form-group">
                      <div class="ui-input-group">
                        <input type="password"  required class="form-control" name="password" pattern=".{8,}" title="Eight or more characters">
                        <span class="input-bar"></span>
                    ...
                    <div class="form-group">
                      <div class="ui-input-group">
                        <input type="password" required  class="form-control" name="cpass" pattern=".{8,}" title="Eight or more characters">
                        <span class="input-bar"></span>
					 ...
					 <div class="form-group">
                      <div class="ui-input-group">
                        <input type="text" required  class="form-control" name="cnumber" pattern="[0-9]{10}" title="only use 10 numbers">
                        <span class="input-bar"></span>
					 ...
					 <div class="form-group">
                      <div class="ui-input-group">
                        <input type="text" required  class="form-control" name="works_at">
                        <span class="input-bar"></span>
					...
					<div class="form-group">
					 ...
					 <option selected="select">Select Qualification</option>
				 ...
				 <center> <input name="submit" type="submit" value="Register" class="color-primary"></center>
                </form>
              </div>
...
palathracontructionspvtltd@gmail.com</a>
							...
							<li>
								<a><i class="ion-ios-telephone fa-icons"></i></a>
							</li>
						</ul>
						<div class="icons-hover-black">
							<a href="javascript:avoid(0);"> <i class="fa fa-facebook"></i>E:
palathracontructionspvtltd@gmail.com </a><a href="javascript:avoid(0);"> <i class="fa fa-twitter"></i> </a><a href="javascript:avoid(0);"> <i class="fa fa-youtube"></i> </a><a href="javascript:avoid(0);"> <i class="fa fa-dribbble"></i> </a><a href="javascript:avoid(0);"> <i class="fa fa-linkedin"></i> </a>
						</div>
					</div>
