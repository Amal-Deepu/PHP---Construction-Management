...
<head>
 ...
 <section class="inner-intro bg-img light-color overlay-before parallax-background">
    <div class="container">
      <div class="row title">
      	<div class="title_row">
      		<h1 data-title="Login"><span>Client Login</span></h1>
        ...
        <div class="col-sm-12">
        	<div class="main-body">
        	  <div class="body-inner">
        	    <div class="card bg-white">
        	      <div class="card-content">
					...
					<center>
					        ...
					        <form class="form-horizontal ng-pristine ng-valid" action="login_client_code.php" method="POST">
        	          <fieldset>
        	    ...
        	    <div class="additional-info"> <a href="client_forgotpassword.php">forgotpassword?</a></div>
				 <div class="additional-info"> <a href="client_signup.php">Client's Click here to Register</a></div>
