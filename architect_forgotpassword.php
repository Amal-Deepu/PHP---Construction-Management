...
$name=$_POST['fullname'];
$email=$_POST['email'];
$query=mysqli_query($con,"select password from  tbl_architect where fullName='$name' and email='$email'");
...
$body ="Your password for Buildque login is :".$password;
...
echo "<script>window.location.href ='architect_forgotpassword.php'</script>";
        ...
        <div class="col-sm-12">
        	<div class="main-body">
        	  <div class="body-inner">
        	    <div class="card bg-white">
        	      <div class="card-content">
        	        <section class="logo text-center">
        	          <h2>Architect Forgotpassword</h2>
        	        </section>
					<center>
        	    ...
        	    <div class="additional-info"> <a href="login_architect.php"> Click here to Login</a></div>
